...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Data Konsultasi
...
$query = mysqli_query($connection, " SELECT k.id, CONCAT('A-','EP-',k.id_anggota) id_anggota, a.nama, a.username, a.email, k.keluhan FROM konsultasi k JOIN anggota a ON k.id_anggota = a.id WHERE username = '".$_SESSION['username']."' ");
$no = 1;
    ...
    ?>
            ...
            <td>
              <form action="diagnosa.php" method="POST">
                <input type="hidden" name="diagnosa_id" value="<?php echo $data['id']; ?>">
                <button type="submit" name="diagnosa_btn" class="btn btn-warning">Diagnosa</button>
              </form>
            </td>
          </tr>
          <?php
