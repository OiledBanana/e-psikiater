...
$query = "SELECT id FROM anggota ORDER BY id";
$query_run = mysqli_query($connection, $query);

$data = mysqli_num_rows($query_run);

echo '<h4> Anggota : ' . $data . '</h4>';
?>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Jumlah Post</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">
              
<?php

$query = "SELECT id FROM posting ORDER BY id";
$query_run = mysqli_query($connection, $query);
